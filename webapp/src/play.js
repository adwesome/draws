...
async function create_drawings_list() {
  ...
  if (wins)
    ...
    html_past = `<p class="stats-clarify">Вы участвовали в розыгрыше ${times(lost)}, но пока ни разу не выиграли. Нужно больше участий. <b>На данный момент, почти со 100% вероятностью выигрывают за 14 дней участий подряд.</b> Просто продолжайте участвовать &mdash; и вы выиграете!</p>` + html_past;
...
function tell_em() {
  let content = '<p style="margin-top: 0em;">Сертификаты "Лента", подарки от "Магнит Косметик" &mdash; розыгрыши каждый день до 31 декабря 2024. "Ювелир Pride" &mdash; розыгрыши всю неделю с 16 по 22 декабря 2024.</p>';
  ...
  content += '<br><p style="font-size: 1.1em; color: #fab90b;">👉 Если вы &mdash; владелец или сотрудник организации (или вы знаете владельца организации) и вы хотите, чтобы ваша (эта) организация тоже участвовала в розыгрышах, пожалуйста, напишите нам об этом в чат боте (там, где вы нажимаете кнопку "Играть")!</p>'
