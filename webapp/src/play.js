...
function on_holidays() {
  let content = '<p style="font-size: 1.2em"><b>Розыгрышей сейчас нет, т.к. мы готовим систему и компании к новым розыгрышам</b></p><p>Примерная дата начала розыгрышей: 1&nbsp;февраля 2025. Мы обязательно пришлем вам уведомление в боте, когда розыгрыши снова начнутся 👍</p>';
...
function modal_explain_chances_to_win() {
  ...
  content += '<p class="p-margin">&nbsp;&nbsp;&nbsp;<b>Индикатор шансов на выигрыш</b> (зеленая полоса) показывает текущие шансы для каждого отдельного участника в каждый отдельный день участия в розыгрышах. Индикатор создан для того, чтобы ответить на вопросы участников: "Какие мои шансы на выигрыш сейчас?" и "Как скоро я могу рассчитывать на выигрыш?". Положение индикатора меняется 1 раз в день (ночью) во время расчета победителей прошедшего дня.</p>\
    ...
    <p class="p-margin">&nbsp;&nbsp;&nbsp;Ваши <b>шансы на выигрыш растут</b> каждый раз, когда вы не выигрываете. Таким образом, каждый проигрыш только приближает вас к выигрышу.</p>\
    <p class="p-margin">&nbsp;&nbsp;&nbsp;Ваши <b>шансы на выигрыш не растут</b> (но уменьшаются), если вы пропускаете розыгрыш. Каждый раз, когда вы пропускаете розыгрыш, вас обходят другие участники в накоплении "шансов на выигрыш" &mdash; что приводит к тому, что ваши шансы на выигрыш (по отношению к другим участникам) уменьшаются.</p>\
    ...
    <p class="p-margin">&nbsp;&nbsp;&nbsp;Также вы можете <a href="https://telegram.me/share/url?url=https://telegram.me/adte_bot?start=irrr" target="_blank">пригласить к участию ваших родных и близких</a>. Ваши личные шансы от этого не изменятся, но зато увеличатся ваши совместные шансы на выигрыш: вместе вы выиграете больше подарков 👍</p>\
