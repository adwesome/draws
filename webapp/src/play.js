...
function on_holidays() {
  let content = '<p style="font-size: 1.2em"><b>👋 Друзья, мы видим, что вы заходите, чтобы проверить, не начались ли розыгрыши. Розыгрышей сейчас нет, т.к. мы готовим систему и компании к новым розыгрышам</b></p><p>Примерная дата начала розыгрышей: 1&nbsp;февраля 2025. Мы обязательно пришлем вам уведомление в боте, когда розыгрыши снова начнутся 👍</p>';
