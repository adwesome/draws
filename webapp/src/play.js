      ...
      if (status >= 1) {
        if (gift.includes("https")) {
          ...
          if (brand == "Магнит Косметик")
            html_past += `<p><b>Чтобы получить подарок</b>, приходите на кассу в "Магнит Косметик" (бул. Советов, 3, с 9:30 до 21:30 ежедневно), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
          else
            html_past += `<p><b>Чтобы получить подарок</b>, приходите до 15 декабря (воскресенье) включительно на кассу в "Восточные сладости" (бул. Советов, 5А, с 9:00 до 19:00 ежедневно), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
        }
