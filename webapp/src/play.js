      ...
      if (status >= 1) {
        if (gift.includes("https")) {
          ...
          if (brand == "Магнит Косметик")
            html_past += `<p><b>Чтобы получить подарок</b>, приходите до 31 декабря 2024 (включительно) на кассу в "Магнит Косметик" (участвует только магазин по адресу бул. Советов, 3, часы работы: с 9:30 до 21:30 ежедневно), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
          else
            html_past += `<p><b>Чтобы получить подарок</b>, приходите до 15 декабря (воскресенье) включительно на кассу в "Восточные сладости" (<b>участвует только магазин по адресу бул. Советов, 5А</b>, с 9:00 до 19:00 ежедневно), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
        }
