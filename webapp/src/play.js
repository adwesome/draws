...
async function create_drawings_list() {
  ...
  html_past = '<p class="transfer-data-hint">❇️ Если вы участвовали в розыгрыше 15-16 ноября из браузера, то вы можете перенести всю свою историю и настройки сюда. Для этого, откройте <a href="https://adwesome.github.io/draws/webapp" target="_blank">adwesome.github.io/draws/webapp</a> в браузере, в котором вы участвовали, и следуйте инструкции.</p>' + html_past;
