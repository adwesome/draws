      ...
      if (status >= 1) {
        if (gift.includes("https")) {
          ...
          if (brand == "Магнит Косметик")
            ...
            html_past += `<p><b>Чтобы получить подарок</b>, приходите до 15 декабря (воскресенье) включительно на кассу в "Восточные сладости" (участвует только магазин по адресу: Сегежа, бул. Советов, 5А, часы работы: ежедневно с 9:00 до 19:00), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
        }
...
async function play() {
  ...
  if (ad == 'img/ads/ad-lenta-pro.jpg' && !is_newcomer()) {
    let content = '<p style="margin-top: 0em;">"Лента", "Магнит Косметик" &mdash; розыгрыши каждый день до 31 декабря 2024. "Восточные сладости" &mdash; розыгрыши каждый день до 15 декабря 2024 (успейте купить со скидкой и/или забрать свой подарок).<br><br>Готовится к участию: "Ювелир Pride"</p>';
