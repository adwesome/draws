...
const uids_to_names = {
  1096170666: "Кирилл", // 1729194120208
  5322015870: "Саша", // 1729192694924
  359070623: "Лёша 1", // 1730937393641
  5026988889: "Аксинья", // 1729192688287
  1967872358: "Егор", // 1731175639000
  1563924371: "Даша 1", // 1729196094457
  1636956987: "Ксюша", // 1731401972623
  6371357131: "Рома",
  5262399557: "Таня", // 1730943109814
  1016952170: "Наташа", // 1730995834338
  5838588705: "Алёна", // 1731395761130
  6160219684: "Даша 2",
...
async function create_drawings_list() {
  ...
  if (uid != 1730926893589)
    html_past = '<p class="transfer-data-hint">❇️ Если вы участвовали в розыгрыше 15-16 ноября из браузера, то вы можете перенести всю свою историю и настройки сюда. Для этого, откройте <a href="https://adwesome.github.io/draws/webapp/index.html?v=10" target="_blank">adwesome.github.io/draws/webapp?v=1</a> в браузере, в котором вы участвовали, и следуйте инструкции.</p>' + html_past;
