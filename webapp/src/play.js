      ...
      if (status >= 1) {
        if (gift.includes("https")) {
          ...
          if (brand == "Магнит Косметик")
            html_past += `<p><b>Чтобы получить подарок</b>, приходите на кассу в "Магнит Косметик" (<b>участвует только магазин по адресу бул. Советов, 3</b>, часы работы: с 9:30 до 21:30 ежедневно), назовите код: <b>${gift}</b> &mdash; и получите подарок!</p>`;
          else
