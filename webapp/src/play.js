...
function on_holidays() {
  let content = '<p style="font-size: 1.2em"><b>Розыгрышей сейчас нет, т.к. мы готовим систему и компании к новым розыгрышам</b></p><p>Примерная дата начала розыгрышей: 27 января 2025. Мы пришлем вам уведомление в боте, когда розыгрыши снова начнутся 👍</p>';
