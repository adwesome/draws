  ...
  for (let i = 0; i < history.length; i++) {
    ...
    if (date_participated < date_today) {
      ...
      if (status >= 1) {
        ...
        html_past += `<p style="font-size: 0.85em;">Поздравляем! Вы &mdash; счастливчик! Мы также были бы вам особенно признательны, если вы сообщите о своем выигрыше в комментарии под <a href="https://vk.com/segezhadays" target="_blank">постом</a> &mdash; чтобы другие видели, что розыгрыш настоящий, что это не обман. Спасибо!</p>`;
      }
    }
